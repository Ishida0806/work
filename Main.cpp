...
LPCWSTR g_szAppName = L"スマッシュバレット";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"ColisionWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"ColisionWindowClass", g_szAppName, WS_MY_WINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, nullptr, nullptr, hInstance,
            nullptr);
        // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"ColisionWindowClass", g_szAppName, WS_POPUP,
...
#pragma endregion  
    ...
    case WM_MENUCHAR:
        // メニューがアクティブでユーザーがニーモニックキーまたはアクセラレータキーに対応しないキーを押した。
       // エラービープ音が鳴らないようにする
